let FAQ = [
  ...
  },
  {
    ...
    Answer:
      "Hackathons are not only for programmers! Students from different disciplines are just as important to create a well-rounded project. If you are a passionate learner looking to build something cool, we want you to apply!"
  },
  {
    Question: "What will I need?",
    Answer:
      "Make sure to bring a valid ID! The rest will depend on what you will need to work on your project. Here is a list of what we recommend bringing for the event: your laptop, phone and their respective chargers, toiletries, a change of clothes, and a blanket."
  },
  {
